...
@Component({
  ...
  template: `
            ...
            <h4 [class]="textInfo" class="text-big"> Property binding and class attribute used together=>
            class attr will elapsed. like here text-big is not working </h4> <br>
            <h4 [class.text-alert]="hasAlert"> conditionally use of single class "text-alert"==>
            for this class property is followed by class name.<p> //use single class conditoinally==>
            change the boolean value to display the effect of condition . </p> <p>
            //if true then text-alert class will apply otherwise the color of text will be black.</p> </h4> <br>
